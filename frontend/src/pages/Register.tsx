    ...
    >
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold tracking-tight" style={{ color: '#2c2416' }}>Create Account</h1>
          <p className="text-sm mt-1.5" style={{ color: '#8a7d68' }}>Join TimelineApp today</p>
        </div>
