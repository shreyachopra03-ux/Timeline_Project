...
import { uploadPhoto, uploadBulkPhotos, getUserTimeline, editUserPhoto, deletePhoto, deleteBulkPhotos } from "../controllers/photoController";
...
// Delete bulk photos
photoRouter.delete("/bulk-delete", deleteBulkPhotos  as any);
